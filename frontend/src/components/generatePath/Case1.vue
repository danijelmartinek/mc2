<template>
    <div id="case1">
			...
			<div class="dropdown-container drow">
				<div class="dropdown-icon dcol xs-2 m-1 l-1">
				...
				<div class="dropdown dcol xs-10 m-11 l-11">
					<v-select 
						class="style-chooser" 
						label="naziv" 
				...
				<div class="dropdown-icon confirm-btn dcol xs-2 m-1 l-1" @click="confirm()" v-if="!validator">Potvrdi</div>
				<div class="confirm-btn-disabled dcol xs-2 m-1 l-1" v-if="validator">Potvrdi</div>
			</div>
	</div>
</template>
