...
export default {
  ...
  mounted(){
    ...
    changeCheckedPlus() {
      ...
      x[this.step - 1].checked = false
      x[this.step].checked = true
    },

    changeCheckedMinus() {
      let y = document.getElementsByTagName("input")
      y[this.step + 1].checked = false
...
.checkmark {
  ...
  width: 3em;
  padding: 0.7em;
  box-shadow: 0px 10px 35px 5px rgb(106, 106, 108, 0.50);
